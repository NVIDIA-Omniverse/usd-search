...
description: |
  Spatial and scene-graph queries against USD scenes via the Asset
  Graph Service: proximity ("objects near X"), bounding-box ("objects
  in region Y"), prim enumeration/filtering, and dependency graphs.
  Use when the user asks "what's near", "in this scene", "what does
  this reference", or wants the prim tree.
---
