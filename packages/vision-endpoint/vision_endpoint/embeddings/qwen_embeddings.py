...
class QwenEmbeddings(BaseEmbeddings):
    def __init__(self, embeddings_config: Optional[EmbeddingsConfig] = None):
        ...
        super().__init__(
            ...
            embeddings_service=EmbeddingsService.qwen,
