...
class USDGraphSpatialApi:
    ...
    async def get_prims_within_bounding_box_asset_graph_usd_prims_spatial_bbox_get(
        ...
        prim_type: Annotated[
            Optional[StrictStr],
            Field(
                description="Retrieve prims of the specified type. Can also provide a comma-separated list to retrieve multiple types."
            ),
        ] = None,
        ...
        :type scene_url: str
        :param min_bbox_x: Query bounding box minimum X
        :type min_bbox_x: float
        :param min_bbox_y: Query bounding box minimum Y
        :type min_bbox_y: float
        :param min_bbox_z: Query bounding box minimum Z
        :type min_bbox_z: float
        :param max_bbox_x: Query bounding box maximum X
        :type max_bbox_x: float
        :param max_bbox_y: Query bounding box maximum Y
        :type max_bbox_y: float
        :param max_bbox_z: Query bounding box maximum Z
        :type max_bbox_z: float
        :param limit: Page size
        :type limit: int
        :param prim_type: Retrieve prims of the specified type. Can also provide a comma-separated list to retrieve multiple types.
        :type prim_type: str
