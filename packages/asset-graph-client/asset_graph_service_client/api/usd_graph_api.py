...
class USDGraphApi:
    ...
    async def get_prims_asset_graph_usd_prims_get(
        ...
        usd_path: Annotated[
            Optional[StrictStr],
            Field(description="Retrieve the prim at the specified USD path."),
        ] = None,
        root_prim: Annotated[Optional[StrictBool], Field(description="Retrieve root prims")] = None,
        default_prim: Annotated[Optional[StrictBool], Field(description="Retrieve default prims")] = None,
        ...
        :type scene_url: str
        :param usd_path: Retrieve the prim at the specified USD path.
        :type usd_path: str
        :param root_prim: Retrieve root prims
        :type root_prim: bool
        :param default_prim: Retrieve default prims
    ...
    async def scene_summary_asset_graph_usd_scene_summary_get(
        self,
        scene_url: Annotated[Optional[StrictStr], Field(description="Scene summary")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[Annotated[StrictFloat, Field(gt=0)], Annotated[StrictFloat, Field(gt=0)]],
