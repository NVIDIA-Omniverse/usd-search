...
**185** unique `(package, version)` entries.
...
| `aiohttp` | 3.13.5 | Apache-2.0 AND MIT | <https://github.com/aio-libs/aiohttp> | asset-graph-builder, rendering-job, workspace | [`licenses/aiohttp-3.13.5.txt`](licenses/aiohttp-3.13.5.txt) |
...
| `anthropic` | 0.96.0 | MIT | <https://github.com/anthropics/anthropic-sdk-python> | workspace | [`licenses/anthropic-0.96.0.txt`](licenses/anthropic-0.96.0.txt) |
...
| `async-timeout` | 4.0.3 | Apache 2 | <https://github.com/aio-libs/async-timeout> | workspace | [`licenses/async-timeout-4.0.3.txt`](licenses/async-timeout-4.0.3.txt) |
| `async-timeout` | 5.0.1 | Apache 2 | <https://github.com/aio-libs/async-timeout> | asset-graph-builder, rendering-job, workspace | [`licenses/async-timeout-5.0.1.txt`](licenses/async-timeout-5.0.1.txt) |
...
| `cryptography` | 46.0.7 | Apache-2.0 OR BSD-3-Clause | <https://pypi.org/project/cryptography/> | workspace | [`licenses/cryptography-46.0.7.txt`](licenses/cryptography-46.0.7.txt) |
| `cryptography` | 48.0.0 | Apache-2.0 OR BSD-3-Clause | <https://pypi.org/project/cryptography/> | asset-graph-builder, rendering-job | [`licenses/cryptography-48.0.0.txt`](licenses/cryptography-48.0.0.txt) |
...
| `docstring-parser` | 0.18.0 | MIT | <https://pypi.org/project/docstring-parser/> | workspace | [`licenses/docstring-parser-0.18.0.txt`](licenses/docstring-parser-0.18.0.txt) |
...
| `exceptiongroup` | 1.3.1 | MIT License | <https://pypi.org/project/exceptiongroup/> | asset-graph-builder, siglip2-triton, workspace | [`licenses/exceptiongroup-1.3.1.txt`](licenses/exceptiongroup-1.3.1.txt) |
...
| `httpx-sse` | 0.4.3 | MIT | <https://github.com/florimondmanca/httpx-sse> | workspace | [`licenses/httpx-sse-0.4.3.txt`](licenses/httpx-sse-0.4.3.txt) |
...
| `idna` | 3.12 | BSD-3-Clause | <https://github.com/kjd/idna> | workspace | [`licenses/idna-3.12.txt`](licenses/idna-3.12.txt) |
| `idna` | 3.14 | BSD-3-Clause | <https://github.com/kjd/idna> | asset-graph-builder, rendering-job | [`licenses/idna-3.14.txt`](licenses/idna-3.14.txt) |
| `idna` | 3.15 | BSD-3-Clause | <https://github.com/kjd/idna> | siglip2-triton | [`licenses/idna-3.15.txt`](licenses/idna-3.15.txt) |
...
| `joserfc` | 1.6.4 | BSD-3-Clause | <https://github.com/authlib/joserfc> | workspace | [`licenses/joserfc-1.6.4.txt`](licenses/joserfc-1.6.4.txt) |
| `joserfc` | 1.6.5 | BSD-3-Clause | <https://github.com/authlib/joserfc> | asset-graph-builder, rendering-job | [`licenses/joserfc-1.6.5.txt`](licenses/joserfc-1.6.5.txt) |
...
| `langchain` | 1.3.0 | MIT | <https://docs.langchain.com/> | workspace | [`licenses/langchain-1.3.0.txt`](licenses/langchain-1.3.0.txt) |
| `langchain-anthropic` | 1.4.1 | MIT | <https://docs.langchain.com/oss/python/integrations/providers/anthropic> | workspace | [`licenses/langchain-anthropic-1.4.1.txt`](licenses/langchain-anthropic-1.4.1.txt) |
...
| `langchain-core` | 1.4.0 | MIT | <https://docs.langchain.com/> | workspace | [`licenses/langchain-core-1.4.0.txt`](licenses/langchain-core-1.4.0.txt) |
| `langchain-mistralai` | 1.1.2 | MIT | <https://docs.langchain.com/oss/python/integrations/providers/mistralai> | workspace | [`licenses/langchain-mistralai-1.1.2.txt`](licenses/langchain-mistralai-1.1.2.txt) |
...
| `langchain-protocol` | 0.0.15 | MIT | <https://github.com/langchain-ai/agent-protocol/tree/main/streaming> | workspace | [`licenses/langchain-protocol-0.0.15.txt`](licenses/langchain-protocol-0.0.15.txt) |
...
| `langgraph` | 1.2.0 | MIT | <https://docs.langchain.com/oss/python/langgraph/overview> | workspace | [`licenses/langgraph-1.2.0.txt`](licenses/langgraph-1.2.0.txt) |
| `langgraph-checkpoint` | 4.1.0 | MIT | <https://github.com/langchain-ai/langgraph/tree/main/libs/checkpoint> | workspace | [`licenses/langgraph-checkpoint-4.1.0.txt`](licenses/langgraph-checkpoint-4.1.0.txt) |
...
| `langgraph-sdk` | 0.3.13 | MIT | <https://github.com/langchain-ai/langgraph/tree/main/libs/sdk-py> | workspace | [`licenses/langgraph-sdk-0.3.13.txt`](licenses/langgraph-sdk-0.3.13.txt) |
| `langsmith` | 0.8.4 | MIT | <https://smith.langchain.com/> | workspace | [`licenses/langsmith-0.8.4.txt`](licenses/langsmith-0.8.4.txt) |
...
| `numpy` | 1.26.4 | BSD License | <https://numpy.org> | rendering-job, siglip2-triton, workspace | [`licenses/numpy-1.26.4.txt`](licenses/numpy-1.26.4.txt) |
...
| `orjson` | 3.11.9 | MPL-2.0 AND (Apache-2.0 OR MIT) | <https://pypi.org/project/orjson/> | rendering-job | [`licenses/orjson-3.11.9.txt`](licenses/orjson-3.11.9.txt) |
...
| `prometheus-fastapi-instrumentator` | 7.1.0 | ISC | <https://github.com/trallnag/prometheus-fastapi-instrumentator> | rendering-job, workspace | [`licenses/prometheus-fastapi-instrumentator-7.1.0.txt`](licenses/prometheus-fastapi-instrumentator-7.1.0.txt) |
...
| `pydantic-settings` | 2.14.0 | MIT | <https://github.com/pydantic/pydantic-settings> | workspace | [`licenses/pydantic-settings-2.14.0.txt`](licenses/pydantic-settings-2.14.0.txt) |
...
| `pyyaml` | 6.0.3 | MIT | <https://pyyaml.org/> | rendering-job, siglip2-triton, workspace | [`licenses/pyyaml-6.0.3.txt`](licenses/pyyaml-6.0.3.txt) |
...
| `starlette` | 0.52.1 | BSD-3-Clause | <https://github.com/Kludex/starlette> | workspace | [`licenses/starlette-0.52.1.txt`](licenses/starlette-0.52.1.txt) |
...
| `websockets` | 10.4 | BSD | <https://github.com/aaugustin/websockets> | workspace | [`licenses/websockets-10.4.txt`](licenses/websockets-10.4.txt) |
...
| `NVIDIA Omniverse Kit (kit-app-template)` | 110.1.0 | NVIDIA Software License Agreement | <https://github.com/NVIDIA-Omniverse/kit-app-template> | asset-graph-builder, rendering-job | [`licenses/extras-nvidia-omniverse-kit-kit-app-template-110.1.0.txt`](licenses/extras-nvidia-omniverse-kit-kit-app-template-110.1.0.txt) | Omniverse Kit kernel + extensions used by the rendering-job and asset-graph-builder images for USD rendering and scene-graph extraction. |
| `NVIDIA Triton Inference Server` | 26.04 | BSD-3-Clause | <https://github.com/triton-inference-server/server> | siglip2-triton | [`licenses/extras-nvidia-triton-inference-server-26.04.txt`](licenses/extras-nvidia-triton-inference-server-26.04.txt) | Base image (nvcr.io/nvidia/tritonserver:26.04-py3) used to serve the SigLIP2 ONNX model ensemble. |
