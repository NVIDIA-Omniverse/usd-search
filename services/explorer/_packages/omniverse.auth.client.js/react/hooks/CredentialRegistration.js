...
export default function useCredentialRegistration() {
    ...
    return useCallback(function (_a) {
        var username = _a.username, password = _a.password, server = _a.server, firstName = _a.firstName, lastName = _a.lastName, email = _a.email, nonce = _a.nonce;
        return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                ...
                return [2 /*return*/, connect(server, Credentials, { "register": 0 })
                        .then(function (conn) { return (credentials = conn); })
                        .then(function (credentials) {
                        return credentials.register({ username: username, password: password, profile: profile, nonce: nonce });
                    })
