...
var ServerForm = function (_a) {
    var className = _a.className, loading = _a.loading, errors = _a.errors, onStart = _a.onStart, onSubmit = _a.onSubmit, onSuccess = _a.onSuccess, onFail = _a.onFail;
    var _b = useInput(""), server = _b[0], setServer = _b[1];
    var check = useCredentialServerCheck();
    var connect = useCallback(function (_a) {
        ...
        return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, check(server)];
                    case 1:
                        connection = _b.sent();
                        if (connection.ok) {
                            return [2 /*return*/, { server: connection.server }];
                        }
                        return [2 /*return*/, { server: connection.server, errors: connection.errors }];
                }
            });
        });
    }, [check]);
    ...
    return (React.createElement(Form, { className: className },
        ...
        React.createElement(FormGroup, null,
            React.createElement(Input, { autoFocus: true, name: "server", placeholder: "Type Server Name", value: server, onChange: setServer })),
