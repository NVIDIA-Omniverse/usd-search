...
try:
    ...
    package_version = version("deepsearch-rendering-job")
except Exception:
    # Method 2: Fallback to __version__ attribute
    try:
        import deepsearch_rendering_job

        package_version = getattr(deepsearch_rendering_job, "__version__", "unknown")
    except Exception:
